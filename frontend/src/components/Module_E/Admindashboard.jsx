...
const MODULES = [
  { id: 'module-a', label: 'Facilities & Assets', description: 'Manage resources, capacities, and availability states.' },
  { id: 'module-b', label: 'Bookings', description: 'Review booking requests and run approval workflows.' },
  { id: 'module-c', label: 'Tickets', description: 'Assign technicians and monitor maintenance progress.' },
  { id: 'module-d', label: 'Notifications', description: 'Track alerts and communication across operations.' },
]
