        ...
        <main className="content">
          <section className="hero">
            <div className="hero-copy">
              ...
              <p className="lead">
                Manage facilities, approve bookings, track incidents, and keep
                the community updated with real-time notifications.
              </p>
          ...
          <section className="module-grid" id="modules">
            <article className="module-card">
              ...
              <p>
                Maintain labs, rooms, and equipment with filters and status.
              </p>
